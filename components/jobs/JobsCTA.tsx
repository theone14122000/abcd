        ...
        >
            ...
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
              <button
                style={{
                  ...
                  border: "none",
                  cursor: "pointer",
                  boxShadow: "0 8px 24px rgba(14,122,112,0.3)",
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "#0e7a70";
          ...
          <div
            style={{
              ...
              boxShadow: "0 12px 36px rgba(13,43,40,0.06)",
            }}
          >
            {/* Stats Badge */}
            <div
              style={{
                ...
                background: "#fff",
                borderRadius: 20,
                boxShadow: "0 8px 24px rgba(13,43,40,0.08)",
                marginBottom: 16,
              }}
            >
              <div
              ...
              <div>
                ...
                >
                  Candidates placed in top Fortune 500s
                </p>
              </div>
            </div>
