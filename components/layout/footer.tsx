      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              ...
              through strategic recruitment solutions.
            </p>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              {["in", "tw", "fb"].map((s) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = "rgba(74,124,89,0.25)";
        ...
        >
          <p style={{ fontSize: "0.82rem", color: "#4b5563" }}>
            © {new Date().getFullYear()} E Choices Career Solutions. All rights reserved.
          </p>
