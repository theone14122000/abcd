  ...
  return (
    <>
        ...
        <div className="footer-inner">
          <div className="footer-grid">
            ...
            <div>
              ...
              <div className="reach-col">
                <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="reach-card rc-wa" aria-label="WhatsApp">
                ...
                <a href={emailLink} className="reach-card rc-em" aria-label="Email">
                  ...
                  <div className="reach-txt">
                    ...
                    <span className="reach-sub reach-email-sub">{EMAIL_ADDRESS}</span>
                  </div>
                  <span className="reach-arr">→</span>
                </a>
              </div>
          ...
          <div className="footer-bottom">
            <p className="copy-text">
              ...
              <span className="copy-brand">E Choices Career Solutions</span>. All rights reserved.
            </p>
            <div className="bottom-links">
              {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((t) => (
                <a key={t} href="#" className="bottom-link">{t}</a>
              ))}
            </div>
          </div>
        </div>
      ...
      <style>{`
        ...
        .reach-card:hover::after { left: 100%; }
        ...
        .ic-em { background: linear-gradient(135deg, #38bdf8, #0e7490); }
        ...
        .bottom-link:hover { color: #6ee7b7; }
        ...
        @media (max-width: 768px) {
          ...
          .footer-brand { grid-column: 1 / -1; }
          .footer-grid > div:last-child { grid-column: 1 / -1; }
          .reach-col { flex-direction: column; }
        }
