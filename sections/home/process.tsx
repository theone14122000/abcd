...
export default function Process() {
  ...
  return (
    <section ref={ref} style={{ width: "100%", padding: "96px 40px",         background:"radial-gradient(circle at 10% 20%, rgba(152,251,152,0.35) 0%, transparent 32%), radial-gradient(circle at 90% 10%, rgba(245,230,66,0.24) 0%, transparent 30%), linear-gradient(180deg, #f8fffe 0%, #dfffdc 100%)",
 }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        >
          ...
          <h2 style={{ fontSize: "2.1rem", fontWeight: 800, background:"linear-gradient(135deg, #0786ad 0%, #1287e7 45%, #046583 100%)",
          ...
          <p style={{ color: "#6b7280", fontSize: "0.95rem", lineHeight: 1.8, maxWidth: 500, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 0, position: "relative" }}>
          ...
          <div
            style={{
              ...
              right: "12.5%",
              height: 2,
              background: "linear-gradient(to right, #4a7c59, #a8c5a0)",
              zIndex: 0,
              opacity: visible ? 1 : 0,
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              >
                <span style={{ fontSize: "0.65rem", color: "rgba(255,255,255,0.7)", fontWeight: 700, letterSpacing: "0.05em" }}>{step.num}</span>
              ...
              >
                <h3 style={{ fontSize: "1rem", fontWeight: 700, color: "#1a1a1a", marginBottom: 10 }}>{step.title}</h3>
                <p style={{ color: "#6b7280", fontSize: "0.84rem", lineHeight: 1.65 }}>{step.desc}</p>
              </div>
            </div>
          ))}
        </div>
